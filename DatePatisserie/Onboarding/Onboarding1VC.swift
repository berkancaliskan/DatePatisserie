...
class Onboarding1VC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        pagePointer.image = UIImage(named: "slider1")
        ...
        onboadingImg.image = UIImage(named: "on_img1")
        onboadingImg.frame = CGRect(x: 0.06 * screenWidth, y: 0.22 * screenHeight, width: 0.9 * screenWidth, height: 0.5 * screenHeight)
        view.addSubview(onboadingImg)
        
        let holderTitle = UILabel()
        holderTitle.text = NSLocalizedString("Browse Anonymously", comment:"")
        ...
        holderTitle.frame = CGRect(x: 0.1 * screenWidth, y: 0.53 * screenHeight, width: 0.8 * screenWidth, height: 0.1 * screenHeight)
        ...
        holderSubTit.frame = CGRect(x: 0.15 * screenWidth, y: 0.56 * screenHeight, width: 0.7 * screenWidth, height: 0.18 * screenHeight)
    ...
    if segue.identifier == "onboarding1to2"{
        ...
        let destination = segue.destination as! Onboarding2VC
