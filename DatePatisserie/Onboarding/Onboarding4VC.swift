...
class Onboarding4VC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        pagePointer.image = UIImage(named: "slider4")
        ...
        onboadingImg.image = UIImage(named: "on_img4")
    ...
    @objc func starButtonClicked() {
        ...
        performSegue(withIdentifier: "onboarding4ToLogin", sender: nil)
        
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {

    if segue.identifier == "onboarding4ToLogin"{
